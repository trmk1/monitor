...
<div id="a">
			...
			<input name="idn"  type="hidden"  value="$idn" >
				...
				<p align='center'><strong><img alt='фото' src='http://www.talgat.idhost.kz/1/foto/upload/$idn.jpg' width='200' height='266'></strong></p>
			...
			<legend>Контактные данные </legend>
				Домашний телефон  8(71536)   <input name="NOMTELEF"  type="text"  value="$NOMTELEF" maxlength="5" size="5">  <br> 
				Рабочий телефон  8(71536)   <input name="RABNOMTELEF"  type="text"  value="$RABNOMTELEF" maxlength="5" size="5">  <br> 	
				Сотовый телефон  8    
...
<div id="b">
		...
		<legend>Курсовая переподготовка</legend>
				...
				Тема курсов     <br><textarea name="TEMAKURS" cols="53">$TEMAKURS</textarea><br>
				...
				Методическая тема <br> <textarea name="METTEMA" cols="53">$METTEMA</textarea><br>
