...
<div id="a">
			...
			<legend>Контактные данные </legend>
				Домашний телефон  8(71436)   <input name="NOMTELEF"  type="text"  value="$NOMTELEF" maxlength="5" size="5">  <br> 
				Рабочий телефон  8(71436)   <input name="RABNOMTELEF"  type="text"  value="$RABNOMTELEF" maxlength="5" size="5">  <br> 	
				Сотовый телефон  8    
				...
				Web-сайт    <input name="WEB"  type="text"  value="$WEB"  >              <br>
					...
					Учебное заведение (ВУЗ, колледж)    <input name="UCHZAVOKON"  type="text"  value="$UCHZAVOKON">     <br>
...
print<<<HERE
					...
					Учебное заведение (ВУЗ, колледж)    <input name="UCHZAVOKON2"  type="text"  value="$UCHZAVOKON2">    <br> 
...
HERE;
						...
						/* echo 	"Преподоваемый предмет (заполняется автоматически из мониторинга здесь ничего заполнять не надо) ";
						$result2 = mysql_query("SELECT * FROM teacher_predmet WHERE cod_teach='$idn' ");
						$s=1;
						
						do 
						{
						$k=$k.$s.")".$myrow2["predmet"]." ".$myrow2["klass"]."-КЛАСС \r\n";
						// $k=$s.")".$k;
						$s=$s+1;
						}
						while ($myrow2 = mysql_fetch_array($result2));
						echo "<textarea disabled name='PREPPREDM' rows='7' cols='40'>$k</textarea><br>"; */
...
<div id="b">
		...
		<legend>Курсовая переподготовка</legend>
				...
				Тема курсов     <br><textarea name="TEMAKURS" cols="43">$TEMAKURS</textarea><br>
				...
				Методическая тема <br> <textarea name="METTEMA" cols="43">$METTEMA</textarea><br>
				Проблемная тема            <br><textarea name="PPOTEMA" cols="43">$PPOTEMA</textarea><br>

				</fieldset>
<fieldset class="fieldset1">
				<legend>Обобщение ПО </legend>

				Место обобщения передогого опыта     <input name="PPOVIBOR"  type="text"  value="$PPOVIBOR">  <br>
				...
				Изданные методические пособия 	  <br><textarea name="IZDANMETOD" cols="43">$IZDANMETOD</textarea><br>
				Республиканского уровня       <br><textarea name="IZDANRESPU" cols="43">$IZDANRESPU</textarea><br>
				
			</fieldset>
				<fieldset class="fieldset1">
				<legend>Награды и достижения</legend>
				
				Награды           <br><textarea name="NAGRADI" cols="43">$NAGRADI</textarea><br>
				</fieldset>
				...
				Общественная работа     <input name="OBCHRAB"  type="text"  value="$OBCHRAB"> <br>
